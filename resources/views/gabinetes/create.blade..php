...
@section('title', 'Novo Gabinete - Sistema Cólera Angola')

@section('content')
<div class="max-w-2xl mx-auto">
    <div class="bg-white shadow-md rounded-lg p-6">
        <h2 class="text-2xl font-bold mb-6">Novo Gabinete de Saúde</h2>
            ...
            <div class="grid grid-cols-1 gap-6">
                ...
                <div>
                    ...
                    <select id="tipo" name="tipo" class="form-input" required>
                        ...
                        <option value="provincial" {{ old('tipo') == 'provincial' ? 'selected' : '' }}>Provincial</option>
                ...
                <div>
                    ...
                    <textarea id="endereco" name="endereco" rows="3" class="form-input">{{ old('endereco') }}</textarea>
                    @error('endereco')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
